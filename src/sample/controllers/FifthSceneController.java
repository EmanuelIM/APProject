...
import sample.algorithm.Reader;
import sample.algorithm.VRPAlg;
...
public class FifthSceneController implements Initializable {
    ...
    public void switchToScene4(ActionEvent event) throws IOException {
        FileWriter fstream = new FileWriter("src/sample/txtFiles/Cars.txt");
        ...
        FileWriter fstreamD = new FileWriter("src/sample/txtFiles/Destinations.txt");
        ...
        FileWriter ostream = new FileWriter("src/sample/txtFiles/Solution.txt");
        ...
        writer.close();
        root = FXMLLoader.load(getClass().getResource("../scenes/Scene4.fxml"));
