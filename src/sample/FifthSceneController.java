...
public class FifthSceneController implements Initializable{
    ...
    public void switchToScene4(ActionEvent event)throws IOException {
        FileWriter fstream = new FileWriter ("C:\\xampp\\htdocs\\BetRat\\APProject\\src\\sample\\Cars.txt");
        ...
        FileWriter fstreamD = new FileWriter ("C:\\xampp\\htdocs\\BetRat\\APProject\\src\\sample\\Destinations.txt");
        ...
        FileWriter ostream = new FileWriter ("C:\\xampp\\htdocs\\BetRat\\APProject\\src\\sample\\Solution.txt");
        ...
        ObservableList<Destination> destinations = FXCollections.observableArrayList();
         for(int i =0; i < 8;i++){
             ...
             while(!ok){
                 ...
                 if(!visited[j]){
                     ok = true;
                     double x = 10 +(500 -10) * random.nextDouble();
                     double y = 10 +(500 -10) * random.nextDouble();
                     double weight;
                     if(i == 0){
                         weight =  0.0;
                     }else {
